...
# Create Labels for Groups and Define Default Layout
...
# group_labels = ["C", "E", "R", "E", "A", "L", "K", "I", "L", "L", "E", "R"]

# group_labels = ["🇨", "🇪", "🇷", "🇪", "🇦", "🇱", "🇰", "🇮", "🇱", "🇱", "🇪", "🇷"]

group_layouts = ["columns", "columns", "columns", "columns", "columns", "columns", "columns", "columns", "columns", "columns", "columns", "columns"]

# Add Group Names, Labels and Layouts
     ...
     keys.extend(
            [
                ...
                # mod1 + shift + letter of group = switch to & move focused window to group
                 ...
                 Key([mod, "shift"], i.name, lazy.window.togroup(i.name, switch_group=True), desc="Switch to & move focused window to group {}"),
